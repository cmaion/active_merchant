  ...
  module Billing #:nodoc:
    module Integrations #:nodoc:
      module Paypal
        ...
        # Overwrite this if you want to change the Paypal IPN test url
        mattr_accessor :test_ipn_url
        self.test_ipn_url = 'https://ipnpb.sandbox.paypal.com/cgi-bin/webscr'

        # Overwrite this if you want to change the Paypal IPN production url
        mattr_accessor :production_ipn_url
        self.production_ipn_url = 'https://ipnpb.paypal.com/cgi-bin/webscr'
        ...
        def self.ipn_service_url
          mode = ActiveMerchant::Billing::Base.integration_mode
          case mode
          when :production
            self.production_ipn_url || self.production_url
          when :test
            self.test_ipn_url || self.test_url
          else
            raise StandardError, "Integration mode set to an invalid value: #{mode}"
          end
        end
